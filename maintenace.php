...
<body>
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM pm_records WHERE typeid = 1 ORDER BY date DESC "; // Replace 'your_table' with the actual table name
    ...
    <div id="myModal" class="modal" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <form action="insert.php" method="post" enctype="multipart/form-data" class="insert-form" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    <input type="text" value="1" id="typePm" name="typePm" style="position: absolute; visibility:hidden">
    ...
    <script>
                ...
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        ...
                        if (data.length > 0) {
                            ...
                            //     var form = event.target; // เรียกใช้งานฟอร์มที่ถูกส่งไป
                            //     var formData = new FormData(form);

                            //     // เพิ่ม pm_id เข้าไปใน FormData
                            //     formData.append('pm_id', pmid);

                            //     // ส่งข้อมูลแก้ไข PM ไปยัง edit.php โดยใช้ฟังก์ชัน sendData()
                            //     sendData(formData);
                            // });
                        }
                    } else {
        ...
        // function updateData() {
        //     var form = document.querySelector('.insert-form');
        //     var formData = new FormData(form);
        ...
        //                 // ดำเนินการหลังจากส่งข้อมูลเสร็จสมบูรณ์
        //                 console.log(xhr.responseText);
        //                 // เพิ่มโค้ดสำหรับปรับปรุง UI หรือการแจ้งเตือนผู้ใช้ได้ตามต้องการ
        //             } else {
        //                 // การส่งข้อมูลไม่สำเร็จ
        //                 console.error('เกิดข้อผิดพลาดในการส่งข้อมูล');
        //             }
