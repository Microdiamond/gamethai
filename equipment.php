...
<body>
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM pm_records WHERE typeid = 2 ORDER BY date DESC"; // Replace 'your_table' with the actual table name
    ...
    <div id="myModal" class="modal" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <form action="insert.php" method="post" enctype="multipart/form-data" class="insert-form" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    <input type="text" value="2" id="typePm" name="typePm" style="position: absolute; visibility:hidden">
